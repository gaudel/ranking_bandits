<!-- Our title -->
<div align="center">
  <h3>(Re)run experiments of PB-MHB</h3>
</div>
...
To use the same version as in the original paper, checkout Git's tag `IDA_2021`.

## Run all the experiments and generate the curves

All the experiments may be ran altogether by executing `run_experiments_IDA_2021.py`, with `bandits_to_rank`, our version of `pyclick`, and `data` in the path. Feel free to change in the head of the file
